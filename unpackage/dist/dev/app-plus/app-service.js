...
(function(vue, shared) {
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode(
        "view",
        { class: "title" },
        vue.toDisplayString(_ctx.$t("index.demo")),
        1
        /* TEXT */
      ),
      vue.createElementVNode(
        "view",
        { class: "description" },
        vue.toDisplayString(_ctx.$t("index.demo-description")),
        1
        /* TEXT */
      ),
      vue.createElementVNode("view", { class: "detail-link" }, [
        vue.createTextVNode(
          vue.toDisplayString(_ctx.$t("index.detail")) + ": ",
          1
          /* TEXT */
        ),
      ...
      vue.createElementVNode(
        "view",
        { class: "locale-setting" },
        vue.toDisplayString(_ctx.$t("index.language-info")),
        1
        /* TEXT */
      ),
      vue.createElementVNode("view", { class: "list-item" }, [
        vue.createElementVNode(
          "text",
          { class: "k" },
          vue.toDisplayString(_ctx.$t("index.system-language")) + ":",
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          { class: "v" },
          vue.toDisplayString($data.systemLocale),
          1
          /* TEXT */
        )
      ]),
      vue.createElementVNode("view", { class: "list-item" }, [
        vue.createElementVNode(
          "text",
          { class: "k" },
          vue.toDisplayString(_ctx.$t("index.application-language")) + ":",
          1
          /* TEXT */
        ),
        vue.createElementVNode(
          "text",
          { class: "v" },
          vue.toDisplayString($data.applicationLocale),
          1
          /* TEXT */
        )
      ]),
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "D:/dev/emrald/pages/index/index.vue"]]);
  ...
  const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__scopeId", "data-v-985e9f3e"], ["__file", "D:/dev/emrald/uni_modules/no-data/components/no-data/no-data.vue"]]);
  ...
  const PagesComponentComponent = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$2], ["__file", "D:/dev/emrald/pages/component/component.vue"]]);
  const _sfc_main$2 = {
    data() {
      return {};
    },
  ...
  const PagesApiApi = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1], ["__file", "D:/dev/emrald/pages/api/api.vue"]]);
  const pages = [
    {
...
详细信息：${s4}`), r3(i3);
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "container" }, [
      vue.createElementVNode(
        "view",
        null,
        vue.toDisplayString(_ctx.$t("schema.name")),
        1
        /* TEXT */
      ),
      ...
      vue.createElementVNode(
        ...
        vue.toDisplayString(_ctx.$t("schema.add")),
        1
        /* TEXT */
      )
    ]);
  }
  const PagesSchemaSchema = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "D:/dev/emrald/pages/schema/schema.vue"]]);
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "D:/dev/emrald/App.vue"]]);
  const en = {
    "locale.auto": "System",
    "locale.en": "English",
    "locale.zh-hans": "简体中文",
